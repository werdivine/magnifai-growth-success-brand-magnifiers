...
export default function TelegramEngineShowcase() {
    return (
        <section style={{
            padding: '80px 2rem',
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            {[
                                ...
                                <div key={stat.label} className="liquid-glass" style={{
                                    padding: '1.5rem',
                                    borderRadius: '16px',
                                    textAlign: 'center',
                                    border: '1px solid rgba(255, 255, 255, 0.05)',
                                    ...
                                    <div style={{ color: '#94a3b8', fontSize: '0.78rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em' }}>{stat.label}</div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div style={{
                            ...
                            <div className="float-3d" style={{
                                ...
                                <Send size={32} color="#fff" style={{ transform: 'translateX(-2px) translateY(1px)' }} />
                            </div>
