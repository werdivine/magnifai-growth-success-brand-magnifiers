...
const InteractiveComponentSlice = ({ slice }: InteractiveComponentProps) => {
    const componentType = slice.primary.component;

    switch (componentType) {
        case 'roi_calculator':
            return (
                <Section theme="light">
                    <h2 style={{ textAlign: 'center', fontSize: '3.5rem', fontFamily: 'var(--font-playfair)', color: '#000', marginBottom: '1rem', lineHeight: 1 }}>{slice.primary.title_override || "Calculate Your Upside"}</h2>
