            ...
            <main style={{ minHeight: '100vh', background: '#0A0A0B' }}>
                ...
                <article style={{ maxWidth: '800px', margin: '0 auto', padding: '6rem 2rem' }}>
                    ...
                    <div style={{ color: '#cbd5e1', fontSize: '1.125rem', lineHeight: 1.8 }}>
                        ...
                        <h2 style={{ fontSize: '1.75rem', color: 'var(--foreground)', fontFamily: 'var(--font-playfair)', margin: '2.5rem 0 1rem' }}>
                        ...
                        <h3 style={{ fontSize: '1.25rem', color: 'var(--foreground)', margin: '2rem 0 1rem' }}>
                        ...
                        <ul style={{ marginBottom: '1.5rem', paddingLeft: '1.5rem' }}>
                            <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: 'var(--foreground)' }}>Week 1:</strong> Audit your current content workflow and identify repetitive tasks</li>
                            <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: 'var(--foreground)' }}>Week 2:</strong> Implement one AI writing tool for blog and social content</li>
                            <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: 'var(--foreground)' }}>Week 3:</strong> Set up automated email sequences with personalization</li>
                            <li style={{ marginBottom: '0.75rem' }}><strong style={{ color: 'var(--foreground)' }}>Week 4:</strong> Connect analytics and begin A/B testing AI-generated vs. human content</li>
                        </ul>
