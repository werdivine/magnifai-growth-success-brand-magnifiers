                    ...
                    <div style={{ color: '#cbd5e1', fontSize: '1.125rem', lineHeight: 1.8 }}>
                        ...
                        <ol style={{ marginBottom: '1.5rem', paddingLeft: '1.5rem' }}>
                            <li style={{ marginBottom: '1rem' }}>
                                <strong style={{ color: 'var(--foreground)' }}>Trigger:</strong> New blog post published (via RSS or webhook)
                            </li>
                            <li style={{ marginBottom: '1rem' }}>
                                <strong style={{ color: 'var(--foreground)' }}>Action 1:</strong> Send to Claude API to generate 5 social post variations
                            </li>
                            <li style={{ marginBottom: '1rem' }}>
                                <strong style={{ color: 'var(--foreground)' }}>Action 2:</strong> Create image with featured image + title overlay
                            </li>
                            <li style={{ marginBottom: '1rem' }}>
                                <strong style={{ color: 'var(--foreground)' }}>Action 3:</strong> Schedule posts to Buffer (1 immediate, 4 over next week)
                            </li>
                            <li style={{ marginBottom: '1rem' }}>
                                <strong style={{ color: 'var(--foreground)' }}>Action 4:</strong> Send summary to your Slack channel
                            </li>
                        </ol>
