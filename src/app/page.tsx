        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div style={{
                    ...
                    margin: '4rem auto 0',
                    padding: '2.5rem 2rem',
                    background: 'linear-gradient(135deg, rgba(var(--foreground-rgb), 0.03) 0%, rgba(var(--foreground-rgb), 0.08) 100%)',
                    ...
                    <div style={{ position: 'absolute', top: '-50%', left: '50%', transform: 'translateX(-50%)', width: '300px', height: '150px', background: 'var(--accent-glow)', filter: 'blur(80px)', opacity: 0.3, zIndex: 0 }} />
                    <span style={{color: 'var(--foreground)', zIndex: 1, fontWeight: 800, fontSize: '1rem', textTransform: 'uppercase', letterSpacing: '0.15em', opacity: 0.8}}>Essential Growth Automations</span>
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap', zIndex: 1, width: '100%' }}>
                        <a href="https://t.me/yourtelegram" target="_blank" rel="noreferrer" style={{
                            display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1rem 2rem', borderRadius: '16px', background: 'linear-gradient(135deg, #22d3ee 0%, #3b82f6 100%)', border: '1px solid rgba(255,255,255,0.2)', color: '#fff', fontWeight: 800, fontSize: '1.1rem', textDecoration: 'none', position: 'relative', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', boxShadow: '0 10px 30px rgba(34,211,238,0.4)', flex: '1 1 250px', justifyContent: 'center'
                        }}>
                            <span style={{ width: 10, height: 10, borderRadius: '50%', background: '#fff', display: 'inline-block', boxShadow: '0 0 15px #fff', animation: 'pulse 2s infinite' }} /> Telegram Engine (Live)
                        </a>
                        <a href="#hubspot" style={{
                            display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1rem 2rem', borderRadius: '16px', background: 'rgba(var(--foreground-rgb), 0.05)', border: '1px solid var(--glass-border)', color: 'var(--foreground)', fontWeight: 700, fontSize: '1.1rem', textDecoration: 'none', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', flex: '1 1 250px', justifyContent: 'center'
                        }}>
                            <span style={{ fontSize: '1.2rem' }}>🟠</span> HubSpot Integrator
                        </a>
                        <a href="#make" style={{
                            display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1rem 2rem', borderRadius: '16px', background: 'rgba(var(--foreground-rgb), 0.05)', border: '1px solid var(--glass-border)', color: 'var(--foreground)', fontWeight: 700, textDecoration: 'none', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', flex: '1 1 250px', justifyContent: 'center'
                        }}>
...
{/* Metrics Strip */}
                ...
                <FadeIn><section className={styles.sectionDark}>
                ...
                {/* Content Strategy & Prompt Engine */}
                        ...
                        <div style={{
                            ...
                            {[
                                ...
                                <Link key={card.href} href={card.href} style={{
                                    ...
                                    <h3 style={{ color: 'var(--foreground)', fontWeight: 700, fontSize: '1.05rem', lineHeight: 1.35, margin: 0 }}>
                                        {card.title}
                                    </h3>
                ...
                <FadeIn><section style={{
                    ...
                    <div style={{ maxWidth: '640px', margin: '0 auto' }}>
                        ...
                        <p style={{ color: 'rgba(var(--foreground-rgb), 0.75)', fontSize: '1.1rem', lineHeight: 1.7, marginBottom: '2.5rem' }}>
                    ...
                    <div style={{ maxWidth: '1300px', margin: '0 auto' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '3rem', flexWrap: 'wrap', gap: '1rem' }}>
                            <div>
                                ...
                                <h2 style={{ fontSize: '2.25rem', fontFamily: 'var(--font-playfair)', color: 'var(--foreground)', margin: 0 }}>
                        ...
                        <div style={{
                            ...
                            {[
                                ...
                                <Link key={resource.href} href={resource.href} style={{
                                    ...
                                    <h3 style={{ color: 'var(--foreground)', fontWeight: 700, fontSize: '1rem', lineHeight: 1.35, marginBottom: '0.5rem' }}>
                                        {resource.title}
                                    </h3>
                        ...
                        <div style={{
                            ...
                            {[
                                ...
                                <div key={tool.name} style={{
                                    ...
                                    <span style={{ color: 'var(--foreground)', fontWeight: 700, fontSize: '0.9rem' }}>{tool.name}</span>
                                </div>
                            ))}
                        </div>
                        <Link href="/growth-stack" style={{
                ...
                <FadeIn><section style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ padding: '2.5rem 2rem' }}>
                            <div style={{
                                display: 'inline-flex', alignItems: 'center', gap: '0.5rem',
                                background: 'rgba(var(--foreground-rgb), 0.06)', border: '1px solid rgba(var(--foreground-rgb), 0.12)',
                                borderRadius: '999px', padding: '0.4rem 1rem',
                                color: '#e2e8f0', fontSize: '0.85rem', fontWeight: 600, marginBottom: '1.5rem',
                            }}>
                                ✅ Free Download
                            </div>
                            <h2 style={{ fontSize: '2.25rem', fontFamily: 'var(--font-playfair)', color: 'var(--foreground)', fontWeight: 800, marginBottom: '0.75rem', lineHeight: 1.2 }}>
                                Get the Website Growth Audit Checklist — Free
                            </h2>
                            <p style={{ color: 'rgba(var(--foreground-rgb), 0.65)', fontSize: '1.05rem', lineHeight: 1.6, marginBottom: '0.75rem' }}>
                                Used by 2,400+ founders and growth teams to find conversion leaks and revenue opportunities.
                            </p>
                            <p style={{ color: 'rgba(var(--foreground-rgb), 0.4)', fontSize: '0.875rem', marginBottom: '2rem' }}>
                                80 checks · 6 sections · Instant access
                            </p>
                            <Link href="/lead-magnets/website-audit-checklist" style={{
                                display: 'inline-flex', alignItems: 'center', gap: '0.5rem',
                                background: 'var(--foreground)', color: 'var(--bg-primary)',
                ...
                {/* Automation Triage Loop (Legacy Restoration) */}
                <FadeIn><AIQuiz /></FadeIn>
                <FadeIn>
                        ...
                        <div style={{
                            ...
                            {[
                                ...
                                <Link key={insight.href} href={insight.href} style={{
                                    ...
                                    <h3 style={{ color: 'var(--foreground)', fontWeight: 700, fontSize: '1.05rem', lineHeight: 1.35, marginBottom: '0.6rem' }}>
                                        {insight.title}
                                    </h3>
                ...
                <FadeIn><section style={{
                    ...
                    <div style={{
                        ...
                        <h2 style={{ fontSize: '2rem', fontFamily: 'var(--font-playfair)', color: 'var(--foreground)', fontWeight: 800, marginBottom: '0.75rem' }}>
                            Join 3,000+ Founders Getting Weekly Growth Intelligence
                        </h2>
                        <p style={{ color: 'rgba(var(--foreground-rgb), 0.6)', fontSize: '1rem', lineHeight: 1.6, marginBottom: '2rem' }}>
                        ...
                        <form action="/newsletter" method="get" style={{
                            ...
                            <button type="submit" style={{
                                padding: '12px 24px',
                                background: 'linear-gradient(135deg, #7c3aed, #2563eb)', color: 'var(--foreground)',
                        ...
                        <p style={{ color: 'rgba(var(--foreground-rgb), 0.3)', fontSize: '0.8rem', marginTop: '1rem' }}>
                            No spam · Unsubscribe anytime · <Link href="/newsletter" style={{ color: '#a78bfa', textDecoration: 'none' }}>See recent issues</Link>
                        </p>
                    </div>
                </section></FadeIn>

                {/* FAQ (Legacy Restoration) */}
                <Section variant="midnight">
                    <FadeIn>
                        <h2 style={{ textAlign: 'center', fontSize: '3.5rem', fontFamily: 'var(--font-playfair)', color: '#000', marginBottom: '4rem', marginTop: '4rem' }}>Frequently Asked Questions</h2>
