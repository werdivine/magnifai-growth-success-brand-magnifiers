            ...
            <main className={styles.servicePage} style={{ '--accent-color': '#ec4899', '--accent-light': '#f472b6', '--icon-bg': 'rgba(236, 72, 153, 0.1)', '--icon-color': '#ec4899' } as React.CSSProperties}>
                ...
                <section className={styles.sectionDark}>
                    <div className={styles.container}>
                        <h2 className={styles.sectionTitle} style={{ color: 'var(--foreground)' }}>What We Create</h2>
                        ...
                        <div className={styles.featuresGrid}>
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Brand Identity</h3>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>UI/UX Design</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Marketing Collateral</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Visual Storytelling</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>AI-Enhanced Design</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                ...
                <section className={styles.processSection}>
                    <div className={styles.container}>
                        <h2 className={styles.sectionTitle} style={{ color: 'var(--foreground)', textAlign: 'center' }}>Our Process</h2>
                ...
                <section className={styles.pricingSection}>
                    <div className={styles.container}>
                        <h2 className={styles.sectionTitle} style={{ color: 'var(--foreground)', textAlign: 'center' }}>Investment Tiers</h2>
