            ...
            <main style={{ minHeight: '100vh' }}>
                ...
                <section className={styles.diagramSection}>
                    <div className={styles.diagramContainer}>
                        <div>
                            <h2 style={{ fontSize: '2.5rem', marginBottom: '1.5rem', color: 'var(--foreground)' }}>From &quot;Chaos&quot; to &quot;Clockwork&quot;</h2>
                            ...
                            <ul style={{ listStyle: 'none', padding: 0 }}>
                                {[
                                    ...
                                    <li key={i} style={{ display: 'flex', alignItems: 'center', gap: '1rem', color: 'var(--foreground)', marginBottom: '1rem', padding: '1rem', background: 'rgba(255,255,255,0.03)', borderRadius: '0.5rem' }}>
                        ...
                        <div className={styles.diagramBox}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', alignItems: 'center', opacity: 0.8 }}>
                                <div style={{ padding: '1rem 2rem', border: '1px solid #fff', borderRadius: '0.5rem', color: 'var(--foreground)' }}>Input: New Lead (Typeform)</div>
                                <ArrowRight style={{ transform: 'rotate(90deg)' }} color="#64748b" />
                                <div style={{ display: 'flex', gap: '2rem' }}>
                                    <div style={{ padding: '1rem', background: 'var(--primary-glow)', border: '1px solid var(--primary)', borderRadius: '0.5rem', color: 'var(--foreground)' }}>AI Qualifier (GPT-4)</div>
                                    <div style={{ padding: '1rem', background: 'var(--secondary-glow)', border: '1px solid var(--secondary)', borderRadius: '0.5rem', color: 'var(--foreground)' }}>CRM Update (Hubspot)</div>
                                </div>
                                <ArrowRight style={{ transform: 'rotate(90deg)' }} color="#64748b" />
                                <div style={{ padding: '1rem 2rem', border: '1px solid #fff', borderRadius: '0.5rem', color: 'var(--foreground)' }}>Output: Booked Call in Calendly</div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className={styles.caseStudySection}>
                    <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        <h2 style={{ fontSize: '2.5rem', color: 'var(--foreground)' }}>The &quot;Compound Effect&quot; of Automation</h2>
                ...
                <section id="pricing" className={styles.pricingSection}>
                    <div className={styles.pricingCard}>
                        <h3 style={{ fontSize: '2rem', color: 'var(--foreground)', marginBottom: '1rem', fontFamily: 'var(--font-playfair)' }}>Custom Workflow Audit</h3>
                        <p style={{ color: '#94a3b8', marginBottom: '2rem', lineHeight: 1.6 }}>
                            We don&apos;t sell &quot;packages&quot; off the shelf. We start with a deep-dive audit of your business processes.
                        </p>
                        <div style={{ fontSize: '3rem', fontWeight: 700, color: 'var(--foreground)', marginBottom: '2rem' }}>
                        ...
                        <button style={{ width: '100%', padding: '1rem', background: 'var(--foreground)', border: 'none', borderRadius: '0.5rem', fontWeight: 700, fontSize: '1rem', cursor: 'pointer' }}>
                            Book Audit Call
                        </button>
