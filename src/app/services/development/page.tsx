            ...
            <main className={styles.servicePage} style={{ '--accent-color': '#f59e0b', '--accent-light': '#fbbf24', '--icon-bg': 'rgba(245, 158, 11, 0.1)', '--icon-color': '#f59e0b' } as React.CSSProperties}>
                ...
                <section className={styles.sectionDark}>
                    <div className={styles.container}>
                        <h2 className={styles.sectionTitle} style={{ color: 'var(--foreground)' }}>Development Services</h2>
                        ...
                        <div className={styles.featuresGrid}>
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Marketing Websites</h3>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Web Applications</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>E-Commerce</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Performance Optimization</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Maintenance & Support</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                ...
                <section className={styles.processSection}>
                    <div className={styles.container}>
                        <h2 className={styles.sectionTitle} style={{ color: 'var(--foreground)', textAlign: 'center' }}>Development Process</h2>
                ...
                <section className={styles.pricingSection}>
                    <div className={styles.container}>
                        <h2 className={styles.sectionTitle} style={{ color: 'var(--foreground)', textAlign: 'center' }}>Project Pricing</h2>
