            ...
            <main className={styles.servicePage} style={{ '--accent-color': '#6366f1', '--accent-light': '#818cf8', '--icon-bg': 'rgba(99, 102, 241, 0.1)', '--icon-color': '#6366f1' } as React.CSSProperties}>
                ...
                <section className={styles.sectionDark}>
                    <div className={styles.container}>
                        <h2 className={styles.sectionTitle} style={{ color: 'var(--foreground)' }}>Our Marketing Stack</h2>
                        ...
                        <div className={styles.featuresGrid}>
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>SEO & Content</h3>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Paid Advertising</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Email Marketing</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Social Media</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                            ...
                            <div className={styles.featureCard}>
                                ...
                                <h3 className={styles.featureTitle} style={{ color: 'var(--foreground)' }}>Growth Analytics</h3>
                                <p className={styles.featureDescription} style={{ color: '#94a3b8' }}>
                ...
                <section className={styles.pricingSection}>
                    <div className={styles.container}>
                        <h2 className={styles.sectionTitle} style={{ color: 'var(--foreground)', textAlign: 'center' }}>Marketing Retainers</h2>
